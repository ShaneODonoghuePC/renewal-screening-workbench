  ...
  return withSession(request, async (session) => {
    ...
    const items = await db
      .select({
        ...
        consolidatedAccounts: policies.consolidatedAccounts,
        latestConsolidatedProfitNegative: policies.latestConsolidatedProfitNegative,
        consolidatedAssetsMovedSignificant: policies.consolidatedAssetsMovedSignificant,
